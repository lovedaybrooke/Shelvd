...
class TestInstruction(TestCase):
    ...
    def test_parse_assigns_attributes_to_new_book(self):
    ...
    @patch("shelvd.models.Book.call_bookdata_api", factories.mock_api_lookup)
    def test_parse_handles_books_amazon_doesnt_know_about(self):
    ...
    @patch("shelvd.models.Book.get_api_data")
    def test_parse_creates_reading_for_new_book(self,
                                                mock_get_api_data):
    ...
    def test_parse_doesnt_end_reading_that_isnt_started(self):
    ...
    def test_setting_existing_nickname(self):
    ...
    def test_setting_nickname_for_unstarted_book(self):
