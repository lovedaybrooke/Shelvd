...
def create_objects_for_models_testing(db):
    b1 = BookFactory(  # book with 2 unended readings: 1 abandoned & 1 not
        ...
        last_action_date=datetime.datetime(2018, 1, 5)
    )
    ...
    r6 = ReadingFactory(  # finished reading of Gay T-Rex
        book_isbn=b6.isbn,
        start_date=datetime.datetime(2017, 10, 13),
