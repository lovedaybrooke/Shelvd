...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Reading.format'
        db.add_column(u'shelvd_reading', 'format',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=500, blank=True),
                      keep_default=False)

        # Adding field 'Reading.rereading'
        db.add_column(u'shelvd_reading', 'rereading',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=500, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Reading.format'
        db.delete_column(u'shelvd_reading', 'format')

        # Deleting field 'Reading.rereading'
        db.delete_column(u'shelvd_reading', 'rereading')
    ...
    models = {
        ...
        u'shelvd.reading': {
            ...
            'format': ('django.db.models.fields.CharField', [], {'max_length': '500', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'rereading': ('django.db.models.fields.CharField', [], {'max_length': '500', 'blank': 'True'}),
