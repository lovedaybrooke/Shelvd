...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'shelvd_book', 'author')

        # Adding M2M table for field author on 'Book'
        m2m_table_name = db.shorten_name(u'shelvd_book_author')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('book', models.ForeignKey(orm[u'shelvd.book'], null=False)),
            ('author', models.ForeignKey(orm[u'shelvd.author'], null=False))
        ))
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'shelvd_book', 'author',
                      self.gf('django.db.models.fields.CharField')(default=261, max_length=500),
                      keep_default=False)

        # Removing M2M table for field author on 'Book'
        db.delete_table(db.shorten_name(u'shelvd_book_author'))
