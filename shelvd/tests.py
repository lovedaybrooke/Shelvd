...
class BookTestCase(TestCase):
    ...
    def test_find_or_create(self):
        ...
        self.assertTrue(len(Book.objects.filter(
            isbn=self.new_book_isbn).all()) == 1,
            "New book not created by Book.find_or_create")
    ...
    def test_author_names(self):
        ...
        self.assertTrue(book.author_names ==
            "Snorri Sturluson & Jessie L. Byock",
    ...
    def test_generate_year_by_year_booklist(self):
        results = OrderedDict([(2016, {'count': 0, 'books': []}), (2015,
            ...
            (2013, {'count': 1, 'books': [{'isbn': u'9780007491520',
            'end_date': 'December 31, 2013', 'title': u'Neuromancer',
            'image_url': u'', 'identifier': u'Neurom', 'page': 320}]})])
    ...
    def test_generate_booklist_abandoned(self):
        list = [{'status': 'abandoned', 'isbn': u'9780006550686', 'end_date':
            'May 24, 2014', 'title': u'The God of Small Things', 'image_url':
            u'', 'identifier': u'9780006550686', 'page': 180}, {'status':
            'abandoned', 'isbn': u'9780061695131', 'end_date':
            'February 24, 2013', 'title': u'Tell My Horse', 'image_url': u'',
            'identifier': u'9780061695131', 'page': 336}]
    ...
    def test_generate_booklist_unfinished(self):
        list = [{'status': 'unfinished', 'isbn': u'9780140449198', 'end_date':
            ...
            'identifier': u'9780140449198', 'page': 205}, {'status':
            'unfinished', 'isbn': u'9780140447552', 'end_date': False, 'title':
